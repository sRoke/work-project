...
class Controller {
    constructor(_$scope,
        ...
        $scope.wxLogin = function () {
            ...
            if($rootScope.wxComAppId && $rootScope.wxMpAppId){
                ...
                $http({
                    ...
                    headers: {
                        "raffleAppp-Id": $stateParams.raffleAppId
                    },
                    data: {}
        ...
        $scope.logout = () => {
            ...
            loginService.setraffleAppId(null);
        ...
        //
        //                 // TODO  1. 检查 localStorage 中是否有 raffleAppId, 且该 raffleAppId真是有效，且当前用户是该 raffleApp 的员工，
        //                 //          则直接跳转，return
        //                 //          清空 localStorage 中的 raffleAppId
        //
        //                 if (loginService.getraffleAppId()) {
        //                     $state.go("main.raffleApp.home");
        //                 }
        //                 else {
        //                     $scope.getraffleAppList();
        //                 }
        //             }
        //         }, function () {
        //
        ...
        ///获取用户raffleApp列表
        $scope.getraffleAppList = () => {
            console.log(`${TAG} => getraffleAppList`);
            ...
            //         }
            //         //TODO 选择raffleApp页面
            //         //loginService.setraffleAppId(resp.data.data.recList[0].id);
            //
