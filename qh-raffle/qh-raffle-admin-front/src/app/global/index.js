...
//     client_id: 'CLIENT_ID_qh-net.kingsilk.qh.activity-wap-front',
...
// 构建配置的数据
var jso = global.jso = new JSO({
    providerID: 'oauth2-authorization-server-activity-wap',
...
}, "oauth2-authorization-server-activity-wap");
...
jso.on('redirect', function (url) {
    /*
     ...
     https://activity.kingsilk.net/local/17100/#/raffleApp/11111/center/main  & restoreUrl=urlEncode(
                                https://activity.kingsilk.net/local/17100/#/a/b
     )
