 ...
 * 保留该接口，方法统一追加自定义方法
 */
public class BaseRepoImpl<T, ID extends Serializable> extends QueryDslMongoRepository<T, ID> implements MongoRepository<T, ID>, net.kingsilk.qh.raffle.repo.BaseRepo<T, ID> {
