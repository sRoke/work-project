package net.kingsilk.qh.raffle;
...
@ConfigurationProperties(prefix = "net.kingsilk.qh.raffle")
@Component
public class QhRaffleProperties {

    private Jwt jwt = null;
    private QhOAuth qhOAuth = null;
    private QhRaffle qhRaffle = null;
    ...
    public QhRaffle getQhRaffle() {
        return qhRaffle;
    }

    public void setQhRaffle(QhRaffle qhRaffle) {
        this.qhRaffle = qhRaffle;
    }
