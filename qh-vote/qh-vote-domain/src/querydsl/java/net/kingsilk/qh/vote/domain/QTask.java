...
public class QTask extends EntityPathBase<Task> {
    ...
    private static final long serialVersionUID = -754704719L;
    ...
    public final EnumPath<net.kingsilk.qh.vote.core.vote.TaskStatusEnum> taskStatus = createEnum("taskStatus", net.kingsilk.qh.vote.core.vote.TaskStatusEnum.class);

    public final EnumPath<net.kingsilk.qh.vote.core.vote.TaskTypeEnum> taskTypeEnum = createEnum("taskTypeEnum", net.kingsilk.qh.vote.core.vote.TaskTypeEnum.class);
    ...
    public final StringPath voteId = createString("voteId");
