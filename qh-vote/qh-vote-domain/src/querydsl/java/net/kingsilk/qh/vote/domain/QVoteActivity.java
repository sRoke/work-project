...
public class QVoteActivity extends EntityPathBase<VoteActivity> {
    ...
    private static final long serialVersionUID = 1729174853L;
    ...
    public final StringPath voteActivityName = createString("voteActivityName");

    public final StringPath voteAppId = createString("voteAppId");
    ...
    public final EnumPath<net.kingsilk.qh.vote.core.vote.VoteStatusEnum> voteStatusEnum = createEnum("voteStatusEnum", net.kingsilk.qh.vote.core.vote.VoteStatusEnum.class);
