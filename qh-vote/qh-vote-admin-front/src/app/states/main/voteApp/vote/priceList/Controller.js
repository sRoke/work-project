...
class Controller {
    constructor(_$scope,
        ...
        $scope.getData = function () {
            $http({
                method: "GET",
                url: conf.apiPath + "/voteApp/" + $stateParams.voteAppId + '/vote/admin/' + $stateParams.id + '/user/' + $stateParams.userId + '/order/info',
                params: {},
                headers: {
        ...
        $scope.deliver = function () {
            ...
            $http({
                method: "PUT",
                url: conf.apiPath + "/voteApp/" + $stateParams.voteAppId + '/vote/admin/' + $stateParams.id + '/user/' + $stateParams.userId + '/order/ship',
                data: {
        ...
        $scope.fallbackPage = function () {
            $state.go("main.voteApp.vote.successPeo", {id:$stateParams.id}, {reload: true});
        };
    }
}
