package net.kingsilk.qh.vote.service;
...
@ConfigurationProperties(prefix = "net.kingsilk.qh.vote")
@Component
public class QhVoteProperties {

    private Jwt jwt = null;
    private QhOAuth qhOAuth = null;
    private QhVote qhVote = null;
    ...
    public QhVote getQhVote() {
        return qhVote;
    }

    public void setQhVote(QhVote qhVote) {
        this.qhVote = qhVote;
    }
