...
import net.kingsilk.qh.vote.service.service.HttpRequestInterceptorService;
import net.kingsilk.qh.vote.service.util.PlainConnectionSocketFactoryEx;
import net.kingsilk.qh.vote.service.util.SSLConnectionSocketFactoryEx;
import net.kingsilk.qh.vote.service.util.errorHandler.Oauth2ResponseErrorHandler;
...
//                ClientHttpRequestFactory fac = new HttpComponentsClientHttpRequestFactory(httpClient)
     ...
     */
    @Bean
    HttpClient wwwHttpClient(QhVoteProperties prop) throws KeyManagementException, NoSuchAlgorithmException {
