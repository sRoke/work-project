...
class Controller {
    constructor(_$scope,
        ...
        $scope.wxLogin = function () {
            ...
            console.log('branComId',$stateParams.voteAppId, $stateParams.backUrl);
        ...
        //         $state.go("main.voteApp.center.main");
        //         // $scope.getUserPhone();
        //     }, {});
        // };
        ...
        //
        //                 // TODO  1. 检查 localStorage 中是否有 voteAppId, 且该 voteAppId真是有效，且当前用户是该 voteApp 的员工，
        //                 //          则直接跳转，return
        //                 //          清空 localStorage 中的 voteAppId
        //
        //                 if (loginService.getvoteAppId()) {
        //                     $state.go("main.voteApp.home");
        //                 }
        //                 else {
        //                     $scope.getvoteAppList();
        //                 }
        //             }
        //         }, function () {
        //
        ...
        ///获取用户voteApp列表
        $scope.getvoteAppList = () => {
            console.log(`${TAG} => getvoteAppList`);
            $state.go("main.voteApp.home", {voteAppId: '59782691f8fdbc1f9b2c4323'}, {reload: true});

            // $http({
            //     method: "GET",
            //     url: conf.apiPath + "/voteApp/bindPhoneAndList",
            //     params: {},
            //     headers: {
            //         'Authorization': 'Bearer ' + loginService.getAccessToken(),
            //     }
            ...
            //         }
            //         //TODO 选择voteApp页面
            //         //loginService.setvoteAppId(resp.data.data.recList[0].id);
            //
            //         console.log('voteAppId ============', resp.data.data.recList[0].id);
            //
            //         $state.go("main.voteApp.shelves", {voteAppId: resp.data.data.recList[0].id}, {reload: true});
            //         //$scope.fallbackPage();
            //     }, function (resp) {
            //         $mdDialog.show({
            //             template: html,
            //             parent: angular.element(document.body).find('#qh-net.kingsilk.qh.vote-wap-front'),
        ...
        $scope.fallbackPage = function () {
            ...
            $state.go("main.voteApp.home", null, {reload: true});
            //
            // if (history.length === 1) {
