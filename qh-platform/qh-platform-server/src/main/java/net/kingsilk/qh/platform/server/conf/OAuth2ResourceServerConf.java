...
public class OAuth2ResourceServerConf {
    ...
    ResourceServerTokenServices resourceServerTokenServices(
        ...
        ts.setClientId(props.getQhPlatform().getServer().getClientId());
        ts.setClientSecret(props.getQhPlatform().getServer().getClientSecret());
...
//    @Bean
//    BrandCompIdFilter brandCompIdFilter() {
//
//        return new BrandCompIdFilter()
//
//    }
    ...
    ResourceServerConfigurerAdapter resourceServerConfigurerAdapter(
        ...
        return new ResourceServerConfigurerAdapter() {
            ...
            public void configure(ResourceServerSecurityConfigurer resources) {
                ...
                resources.resourceId("RSC_ID_qh-platform-server")
...
//                http.addFilterBefore(brandCompIdFilter, X509AuthenticationFilter)
