(function () {
    angular.module('qh-phone-lottery-front')
        ...
        .run(['$rootScope', '$interval', '$state', '$stateParams', '$log', '$cacheFactory', 'errorService','appConfig',
            function ($rootScope, $interval, $state, $stateParams, $log, $cacheFactory, errorService,appConfig) {
                ...
                $rootScope.$on('$stateChangeSuccess', function (event, toState, toParams, fromState, fromParams) {
                    ...
                    var b = appConfig.rootPath.replace('//kingsilk.net','')+'#'+a.replace('main','');
                    console.log(b);
                    _hmt.push(['_setAutoPageview', false]);
                    _hmt.push(['_trackPageview',b]);
