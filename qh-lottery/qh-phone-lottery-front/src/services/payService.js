angular.module('qh-phone-lottery-front').factory('payService', ['appConfig', '$http', '$q', 'alertService', '$timeout', '$httpParamSerializer', "$state", '$mdDialog', '$rootScope', '$mdBottomSheet', '$interval', function (appConfig, $http, $q, alertService, $timeout, $httpParamSerializer, $state, $mdDialog, $rootScope, $mdBottomSheet, $interval) {
