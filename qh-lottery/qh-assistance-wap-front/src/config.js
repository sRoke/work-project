(function () {
    angular.module('qh-assistance-wap-front')
        ...
        .run(['$rootScope', '$interval', '$state', '$stateParams', '$log', '$cacheFactory', 'errorService','wxService','appConfig',
            function ($rootScope, $interval, $state, $stateParams, $log, $cacheFactory, errorService,wxService,appConfig) {
