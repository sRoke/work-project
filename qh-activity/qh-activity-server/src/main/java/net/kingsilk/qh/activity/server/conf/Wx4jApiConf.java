...
public class Wx4jApiConf {
    ...
    public WxComMpUserApi wx4jWxComUserApi(
        ...
        return new WxComMpUserApiImpl(restOperations, qhActivityProperties.getWx4jUt().getBasePath());
    }
    ...
    public WxComMpAtApi wx4jWxComMpAtApi(
        ...
        return new WxComMpAtApiImpl(restOperations, qhActivityProperties.getWx4jUt().getBasePath());
    }
    ...
    public WxScenceApi wx4jWxScenceApi(
        ...
        return new WxScenceApiImpl(restOperations, qhActivityProperties.getWx4jUt().getBasePath());
    }
}
