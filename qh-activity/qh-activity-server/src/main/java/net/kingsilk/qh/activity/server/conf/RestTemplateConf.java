...
import net.kingsilk.qh.activity.service.service.HttpRequestInterceptorService;
import net.kingsilk.qh.activity.service.util.PlainConnectionSocketFactoryEx;
import net.kingsilk.qh.activity.service.util.SSLConnectionSocketFactoryEx;
import net.kingsilk.qh.activity.service.util.errorHandler.Oauth2ResponseErrorHandler;
...
//                ClientHttpRequestFactory fac = new HttpComponentsClientHttpRequestFactory(httpClient)
     ...
     */
    @Bean
    HttpClient wwwHttpClient(QhActivityProperties prop) throws KeyManagementException, NoSuchAlgorithmException {
