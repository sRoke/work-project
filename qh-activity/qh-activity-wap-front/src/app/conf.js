...
function dev() {
    ...
    const devPort = "16500";              //开发端口
    const apiPort = "16500";              //api端口，支付默认api端口
    ...
    let wxPath=`https://kingsilk.net/wx/rs/local/16000/api`; //------------获取jssdk
    let wxComAppId=`wxcee33ae0776a9a96`;

    let brandAppId = `qh-activity-wap-front.${devPort}.brandAppId`;
...
function prod() {
    ...
    let wxComAppId=`wxcee33ae0776a9a96`;
    let brandAppId = `qh-activity-wap-front.brandAppId`;
    let token = `qh.token`;
