...
#endif
{
    ...
    /// <summary>
    /// A disposable cross-activity wrapper around a WriteableBitmap, allowing a common API for Silverlight + WPF with locking + unlocking if necessary
    /// </summary>
 ...
 struct BitmapContext : IDisposable
    {
      ...
      private readonly int* _backBuffer;
        ...
        public BitmapContext(WriteableBitmap writeableBitmap, ReadWriteMode mode)
        {
         ...
         //}
            ...
            double width = _writeableBitmap.BackBufferStride / WriteableBitmapExtensions.4;
      ...
      /// <summary>
      /// Disposes this instance if the underlying activity needs that.
      /// </summary>
      public void Dispose()
      {
