package net.kingsilk.qh.activity.service.service.excelout;
...
public class ExportVoteRecordsService {
    ...
    public void findAndExcelOut(ExportVoteRecordsEvent exportVoteRecordsEvent) {
        String brandAppId = exportVoteRecordsEvent.getBrandAppId();
        String activityId = exportVoteRecordsEvent.getActivityId();
