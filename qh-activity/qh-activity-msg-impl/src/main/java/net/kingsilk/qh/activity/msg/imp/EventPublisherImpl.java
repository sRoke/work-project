package net.kingsilk.qh.activity.msg.imp;
...
//    }
    ...
    public void publish(
        ...
        try {
            ...
            EventPublishEnum publishTo = qhActivityProperties.getMsg().getPublishTo();
...
//            }
            ...
            if (EventPublishEnum.MQ.equals(publishTo)
                ...
                String exchange = qhActivityProperties.getMq().getPrefix()
                        + "."
