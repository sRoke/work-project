...
public class QVoteWorks extends EntityPathBase<VoteWorks> {
    ...
    private static final long serialVersionUID = -953008505L;
    ...
    public final EnumPath<net.kingsilk.qh.activity.core.vote.VoteWorksStatusEnum> status = createEnum("status", net.kingsilk.qh.activity.core.vote.VoteWorksStatusEnum.class);
