package net.kingsilk.qh.shop.api.brandApp.shop.mall.member;
...
//    @Consumes(MediaType.APPLICATION_JSON)
    ...
    UniResp<String> update(
            ...
            @ApiParam(value = "会员id")
            @PathParam(value = "id")
                    String id, MemberModel memberReq
    );
    ...
    UniResp<MemberModel> info(
            ...
            @PathParam(value = "id")
                    String id,
            @ApiParam(value = "公众号平台app id")
            @QueryParam(value = "wxComAppId")
                    String wxComAppId,
            @ApiParam(value = "公众号app id")
            @QueryParam(value = "wxMpAppId")
                    String wxMpAppId
    );
