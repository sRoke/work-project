...
var baseUrls = {
    PROD: "./",
    TEST12: "https://test13.kingsilk.xyz/test/12/shop/mobile/",
    TEST13: "https://test13.kingsilk.xyz/test/13/shop/mobile/",
    TEST14: "https://test13.kingsilk.xyz/test/14/shop/mobile/",
    DEV: "https://test13.kingsilk.xyz/dev/63/shop/mobile/",        //测试
};

console.log('----------', baseUrls[env]);


console.log('----------如果页面不能显示,请检查conf端口和webpack.config.js的baseUrls是否为自己的');
