...
//     client_id: 'CLIENT_ID_qh-net.kingsilk.qh.agency-wap-front',
...
// 构建配置的数据
var jso = global.jso = new JSO({
    providerID: 'oauth2-authorization-server-shop-wap',
    client_id:'CLIENT_ID_qh-front',
    redirect_uri: location.href,
    authorization: conf.wxloginPath + "loginType=WX_SCAN",
    scopes: {request: ['LOGIN']},
    debug: true
});
...
}, "oauth2-authorization-server-shop-wap");
