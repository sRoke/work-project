...
public class Wx4jApiConf {
    ...
    public WxComMpUserApi wx4jWxComUserApi(
        ...
        return new WxComMpUserApiImpl(restOperations, qhShopProperties.getWx4j().getWap().getApi().getUrl());
    }
    ...
    public WxComMpAtApi wx4jWxComMpAtApi(
        ...
        return new WxComMpAtApiImpl(restOperations, qhShopProperties.getWx4j().getWap().getApi().getUrl());
    }
    ...
    public WxScenceApi wx4jWxScenceApi(
        ...
        return new WxScenceApiImpl(restOperations, qhShopProperties.getWx4j().getWap().getApi().getUrl());
    }
