package net.kingsilk.qh.agency.wap.resource.home;

import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;
import net.kingsilk.qh.agency.wap.api.home.HomeApi;
...
public class HomeResource implements HomeApi {
    ...
    @Override
    public String index() {
        return "net.kingsilk.qh.agency.wap : " + new Date();
    }
    ...
    public String swagger(@Context HttpServletResponse response) throws IOException {
        ...
        String url = "https://agency.kingsilk.net/local/11300/rs/webjars/swagger-ui/3.0.19/index.html?url=https://agency.kingsilk.net/local/11300/rs/api/swagger.json";
