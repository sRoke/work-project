...
//        tc.setVerifierKey(props.jwt.verifierKey)
//        return tc
//    }
//
//    @Bean
...
//
    ...
    ResourceServerTokenServices resourceServerTokenServices(
        ...
        ts.setCheckTokenEndpointUrl(props.qhOAuth.wap.checkTokenUri);
        ts.setClientId(props.qhAgency.server.clientId);
        ts.setClientSecret(props.qhAgency.server.clientSecret);
    ...
    ResourceServerConfigurerAdapter resourceServerConfigurerAdapter(
        ...
        return new ResourceServerConfigurerAdapter() {
            ...
            void configure(ResourceServerSecurityConfigurer resources) {
                ...
                resources.resourceId("RSC_ID_qh-agency-server")
            ...
            void configure(HttpSecurity http) throws Exception {
                ...
                http.addFilterBefore(BrandAppIdFilter, X509AuthenticationFilter)
