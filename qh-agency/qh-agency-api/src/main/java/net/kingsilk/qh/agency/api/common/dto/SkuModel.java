...
public class SkuModel extends Base {
     ...
     * 根据不同标签给不同打价格。
     * <p>
     * 标签可以随意定。当前是与 Member 中的 tags 进行匹配。
     * 如果匹配到多个标签，则使用最低价。
     */
     ...
     */
    private Set<ItemModel.UsedItemProp> props = new LinkedHashSet<>();
    ...
    public Set<ItemModel.UsedItemProp> getProps() {
        return props;
    }

    public void setProps(Set<ItemModel.UsedItemProp> props) {
        this.props = props;
    }
