 ...
 */
public class CertificateInfoResp {
    ...
    @ApiModelProperty(value = "关联的授权书模板")
     ...
     * 授权地址信息
     */
    @ApiParam(value = "授权地址abc信息")
    @ApiModelProperty(value = "授权地址abc信息")
    ...
    @ApiModelProperty(value = "所授权的渠道商类型")
    private String prox;
