package net.kingsilk.qh.agency.api.brandApp.staffGroup;
...
import net.kingsilk.qh.agency.api.brandApp.staffGroup.dto.*;
...
@Path("/brandApp/{brandAppId}/staffGroup")
@Component
public interface StaffGroupApi {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @PreAuthorize("isAuthenticated() && hasAnyAuthority('STAFF_GROUP_R')")
    ...
    @POST
    @Produces(MediaType.APPLICATION_JSON)
    @PreAuthorize("isAuthenticated() && hasAnyAuthority('STAFF_GROUP_C')")
    UniResp<String> save(
    ...
    @PUT
    @Produces(MediaType.APPLICATION_JSON)
    @PreAuthorize("isAuthenticated() && hasAnyAuthority('STAFF_GROUP_U')")
    ...
    @DELETE
    @Produces(MediaType.APPLICATION_JSON)
    @PreAuthorize("isAuthenticated() && hasAnyAuthority('STAFF_GROUP_D')")
