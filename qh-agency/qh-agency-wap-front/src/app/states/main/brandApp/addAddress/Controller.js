    ...
    constructor(_$scope,
        ...
        $scope.save = function () {
            ...
            if ($stateParams.id) {
                ...
                $scope.id=$scope.editId ? $scope.editId : null;
                $http({
                    method: "PUT",     ///brandApp/{brandAppId}/partner/{partnerId}/addr/{id}
                    url: conf.apiPath + "/brandApp/" + $scope.brandAppId + "/partner/111111111/addr/" +$scope.id,
                    headers: {
                        'Authorization': 'Bearer ' + loginService.getAccessToken(),
                        'brandApp-Id': $scope.brandAppId
                    },
                    ...
                    $state.go("main.brandApp.address", {orderId: $scope.orderId}, {reload: true})
                }, function (resp) {
                });
                ...
                $http({
                    method: "POST",
                    url: conf.apiPath + "/brandApp/" + $scope.brandAppId + "/partner/111111111/order/"+$scope.orderId+"/addAddr",
                    headers: {
                        'Authorization': 'Bearer ' + loginService.getAccessToken(),
                        'brandApp-Id': $scope.brandAppId
                    },
