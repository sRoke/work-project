    ...
    constructor(_$scope,
        ...
        $scope.fallbackPage = function () {
            if (history.length === 1) {
              ...
              // history.back();
                if($stateParams.id){
                    $state.go("main.brandApp.center.rfAddress", {id:$stateParams.id}, {reload: true});
                }else{
        ...
        $scope.saveInfo = function () {
            ...
            $http({
                method: "PUT",
                url: conf.apiPath + "/brandApp/" + $scope.brandAppId + "/partner/111111111/sysConf/brandAppAddr",
                headers: {
                    'Authorization': 'Bearer ' + loginService.getAccessToken(),
                    'brandApp-Id': $scope.brandAppId
                },
                ...
                if(resp.data.status=='200'){
                    $state.go("main.brandApp.center.rfAddress",{id:resp.data.data}, {reload: true});
                }
            }, function (resp) {
