...
var $scope,
    ...
    alertService;
class Controller {
    constructor(_$scope, _$http, _loginService, _errorService, _$state, _Upload, _$stateParams, _$window, _alertService) {
...
Controller.$inject = [
    '$scope', '$http', 'loginService', 'errorService', '$state', 'Upload', '$stateParams', '$window', 'alertService'
];
