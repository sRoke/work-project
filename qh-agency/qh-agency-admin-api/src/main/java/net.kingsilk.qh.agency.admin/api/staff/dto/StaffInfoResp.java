...
//    public StaffInfoResp convertToResp(Staff staff) {
//        memo = ((String) (staff.memo));
//        userId = ((String) (staff.userId));
//        deleted = ((boolean) (staff.deleted));
//        phone = ((String) (staff.phone));
//        lastModifiedDate = ((Date) (staff.lastModifiedDate));
//        idNumber = ((String) (staff.idNumber));
//        avatar = ((String) (staff.avatar));
//        nickName = ((String) (staff.nickName));
//        realName = ((String) (staff.realName));
//        disabled = ((boolean) (staff.disabled));
//        dateCreated = ((Date) (staff.dateCreated));
//        return this;
//    }
    ...
    @ApiParam(value = "用户组")
    private List<StaffGroup> staffGroupList = new ArrayList<StaffGroup>();
    /**
     * 是否已经禁用。
     * <p>
     * true - 已经禁用。
