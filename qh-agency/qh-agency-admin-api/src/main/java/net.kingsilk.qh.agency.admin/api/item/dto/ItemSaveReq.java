...
public class ItemSaveReq {
    ...
    private java.util.Set<ItemSaveReq.ItemProps> props;
    ...
    private java.util.Set<ItemSaveReq.ItemSku> skuList;
    @ApiModelProperty(value = "商品图片")
    @QueryParam(value = "imgs")
    private java.util.Set<String> imgs = new java.util.HashSet<String>();
