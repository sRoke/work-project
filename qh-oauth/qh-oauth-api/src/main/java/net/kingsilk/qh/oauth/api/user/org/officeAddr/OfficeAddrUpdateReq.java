 ...
 */
@ApiModel
public class OfficeAddrUpdateReq {
    ...
    private Optional<Boolean> defaultAddr = Optional.empty();
    ...
    public Optional<Boolean> getDefaultAddr() {
        return defaultAddr;
    }

    public void setDefaultAddr(Optional<Boolean> defaultAddr) {
